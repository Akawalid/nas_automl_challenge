"""
A series of script that are used in `low_rank_linear_regression.ipynb` notebook
to test the different algorithms to solve the low rank linear regression problem.
"""

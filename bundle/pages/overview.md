...
This year we are running the competition at **AutoML 2026** (2026.automl.cc). AutoML is more alligned with NAS than previous venues, and we think it will be a more suitable home for the competition.
...
Results are to be announced at **AutoML 2026 in Ljubljana, September 28th - October 1st**, with **finalists being informed in August**.

The webpage of the challenge: [nas2026](https://www.nascompetition.com/).

## Get in touch

To stay up-to-date please subscribe to our mailing list. If you have any questions, send us an email.

- [Mailing list](https://lists.ncl.ac.uk/wws/subscribe/nas-workshops)
- [nas-competition-contact@newcastle.ac.uk](mailto:nas-competition-contact@newcastle.ac.uk)

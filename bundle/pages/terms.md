...
- **General Terms:**
    ...
    - You have a 24 hours time limit on Codabench clusters. Your submissions are expected to adapt to the time allotted. If your submission does not finish in time it will recieve a score of -10 for that dataset. Similarly, it needs to respect the memory (RAM and VRAM) of the environment. Any crashes due to memory issues will also lead to a score of -10.
